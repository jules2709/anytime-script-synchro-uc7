...
class Utils
{
    ...
    {
        try {
            // Vérifier si m_reply_uid est présent
            if (isset($messageData['m_reply_uid'])) {
                $query = "
                    INSERT INTO messages (m_uid, m_topic, m_content, m_date, m_status, m_report, m_done, m_reply_uid)
                    VALUES (:m_uid, :m_topic, :m_content, :m_date, :m_status, :m_report, :m_done, :m_reply_uid)
                ";
                ...
                $stmt->execute([
                    ...
                    ':m_reply_uid' => $messageData['m_reply_uid']
                ]);
            } else {
                $query = "
                    INSERT INTO messages (m_uid, m_topic, m_content, m_date, m_status, m_report, m_done)
                    VALUES (:m_uid, :m_topic, :m_content, :m_date, :m_status, :m_report, :m_done)
                ";
